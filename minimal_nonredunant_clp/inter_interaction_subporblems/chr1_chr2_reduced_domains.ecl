...
maximize(RowFile, FreqFile, Non_Zero_Rows) :-
	...
	% apply constraints to the data to ensure they are valid 2-tuple pairs based on the 
	% biological data. note: (0,0) is when we choose to not select anything for that
	% Column row pair
